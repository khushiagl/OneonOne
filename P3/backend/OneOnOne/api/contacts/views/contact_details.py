...
class ContactDetails(generics.RetrieveAPIView):
    ...
    def get_object(self):
        ...
        email = self.request.data.get('contact_email')  # This line is corrected to use .get()
        obj = get_object_or_404(self.queryset, contact_email=email)  # Correct use of get_object_or_404
